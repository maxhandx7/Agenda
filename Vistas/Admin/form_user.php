<form class="box" method="post">
    ...
    <input type="password" name="txtpassword" autocomplete="off" id="txtpassword" placeholder="Contraseña">
    <input type="submit" id="entrar" value="Entrar">
    <a class="btn_reg" id="btn" href="#"> <span style="font-size: 12px;"> Registrar </span></a>
</form>